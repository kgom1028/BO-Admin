	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open('admin/manager_newsletter/do_send/'.$row['id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('select_file');?></label>
                        <div class="col-sm-5">
                            <input type="file" name="userfile" data-validate="required" data-message-required="<?php echo get_phrase('select_required');?>">
                        </div>
                    </div>
            		<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('send_newsletter');?></button>
						</div>
					</div>
        		</form>
            </div>
