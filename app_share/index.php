                ...
                <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <div class="header-bottom-left">
                      <h1>AutoWeigthLoss</h1>
                      <p>AutoWeightLoss is awesome application to loss your weight while listening music and using internet!</p>
          ...
          <div class="screenshots-area">
            <ul class="screenshots-slide">
              <li class="col-md-3 wow fadeInLeft">
               <a class="fancybox" data-fancybox-group="gallery" href="assets/images/app-screenshot-popup-1.png"><img src="assets/images/app-screenshot.jpg" alt="app screenshot">
               ...
               <li class="col-md-3 wow fadeInLeft">
                 <a class="fancybox" data-fancybox-group="gallery" href="assets/images/app-screenshot-popup-2.png"><img src="assets/images/app-screenshot.jpg" alt="app screenshot">
                    <div class="view-btn-area">
                      <span class="fa fa-search view-btn"></span>
                    </div>
                 </a>
               ...
               <li class="col-md-3 wow fadeInLeft">
                 <a class="fancybox" data-fancybox-group="gallery" href="assets/images/app-screenshot-popup-3.png"><img src="assets/images/app-screenshot.jpg" alt="app screenshot">
                  <div class="view-btn-area">
                    <span class="fa fa-search view-btn"></span>
                  </div>
               </a>
